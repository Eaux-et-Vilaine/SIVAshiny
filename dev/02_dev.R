...
#golem::add_module(name = "barrage", with_test = FALSE) # Name of the module
golem::add_module(name = "vilaine_aval", with_test = TRUE) # Name of the module
golem::add_module(name = "passe", with_test=FALSE)
golem::add_module(name = "isac", with_test=FALSE)
...
## Vignette ----
usethis::use_vignette("SIVAshiny")
